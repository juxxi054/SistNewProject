...
public class InsertCar extends JFrame {
    ...
    public void updatecar() {
        ...
        switch (selectmade) {
            case "기아":
                ...
                imagePath = "C:\\sist0217\\work\\javaproject\\sistjavaproject\\src\\Car\\kia.png";  // 절대 경로 사용
                break;
            case "현대":
                carname = new String[]{"아반떼", "소나타", "투싼"};
                imagePath = "C:\\sist0217\\work\\javaproject\\sistjavaproject\\src\\Car\\hyundai.png";  // 절대 경로 사용
                break;
            case "제네시스":
                carname = new String[]{"G70", "G80", "GV80"};
                imagePath = "C:\\sist0217\\work\\javaproject\\sistjavaproject\\src\\Car\\genesis.png";  // 절대 경로 사용
                break;
            case "쉐보레":
                carname = new String[]{"말리부", "트래버스", "스파크"};
                imagePath = "C:\\sist0217\\work\\javaproject\\sistjavaproject\\src\\Car\\chevrolet.png";  // 절대 경로 사용
                break;
        }
    ...
    class Mycanvas extends Canvas {
        ...
        public Mycanvas() {
            // 기본 이미지 설정
            carlogo = new ImageIcon("C:\\sist0217\\work\\javaproject\\sistjavaproject\\src\\Car\\kia.png").getImage();  // 절대 경로로 이미지 로드
        }
